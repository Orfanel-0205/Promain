...
export default function VerifyOtpScreen() {
  ...
  return (
    <View className="flex-1 bg-white px-6 pt-12">
      ...
      <Text className="text-heading-lg font-bold text-teal-900 mb-2">
        Ilagay ang OTP
      </Text>
      ...
      <TextInput
        ...
        maxLength={6}
        className="bg-teal-50 border border-teal-200 rounded-2xl px-4 py-4 text-teal-900 text-center text-2xl tracking-widest mb-6"
      />
      <Pressable
